...
export const mockBooks: Book[] = [
  ...
  },
  {
    ...
    epubUrl: '/books/mockingbird.epub',
    format: 'EPUB',
    genre: 'Classic Fiction',
    rating: 4.5,
    publishedYear: 1960,
  ...
  },
  {
    ...
    epubUrl: '/books/brave-new-world.epub',
    format: 'EPUB',
    genre: 'Science Fiction',
    rating: 4.1,
    publishedYear: 1932,
